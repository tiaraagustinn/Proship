      ...
      {!loading && !error && filteredData.length > 0 && (
        <div className="mt-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-sm text-gray-600">
            ...
            {' '}dari{' '}
            <span className="font-semibold text-gray-800">{filteredData.length}</span>{' '}jadwal
          </p>
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-lg text-sm font-medium bg-teal-700 text-white hover:bg-teal-800 disabled:opacity-30 disabled:cursor-not-allowed transition"
            >
              &laquo;
            </button>
                ...
                item === '...' ? (
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-sm font-medium transition ${
                      currentPage === item
                        ? 'bg-teal-700 text-white font-bold shadow'
